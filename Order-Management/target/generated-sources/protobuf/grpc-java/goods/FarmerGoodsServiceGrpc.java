...
public final class FarmerGoodsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<goods.OrderRequest,
      goods.OrderResponse> getOrderGoodsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "OrderGoods",
      requestType = goods.OrderRequest.class,
      responseType = goods.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<goods.OrderRequest,
      goods.OrderResponse> getOrderGoodsMethod() {
    io.grpc.MethodDescriptor<goods.OrderRequest, goods.OrderResponse> getOrderGoodsMethod;
    if ((getOrderGoodsMethod = FarmerGoodsServiceGrpc.getOrderGoodsMethod) == null) {
      synchronized (FarmerGoodsServiceGrpc.class) {
        if ((getOrderGoodsMethod = FarmerGoodsServiceGrpc.getOrderGoodsMethod) == null) {
          FarmerGoodsServiceGrpc.getOrderGoodsMethod = getOrderGoodsMethod =
              io.grpc.MethodDescriptor.<goods.OrderRequest, goods.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "OrderGoods"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  goods.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  goods.OrderResponse.getDefaultInstance()))
              .setSchemaDescriptor(new FarmerGoodsServiceMethodDescriptorSupplier("OrderGoods"))
              .build();
        }
      }
    }
    return getOrderGoodsMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void orderGoods(goods.OrderRequest request,
        io.grpc.stub.StreamObserver<goods.OrderResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getOrderGoodsMethod(), responseObserver);
    }
  }
  ...
  public static final class FarmerGoodsServiceStub
    ...
    /**
     */
    public void orderGoods(goods.OrderRequest request,
        io.grpc.stub.StreamObserver<goods.OrderResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getOrderGoodsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class FarmerGoodsServiceBlockingStub
    ...
    /**
     */
    public goods.OrderResponse orderGoods(goods.OrderRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getOrderGoodsMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class FarmerGoodsServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<goods.OrderResponse> orderGoods(
        goods.OrderRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getOrderGoodsMethod(), getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_ORDER_GOODS = 4;
      ...
      switch (methodId) {
        ...
        case METHODID_EDITE_GOODS:
          serviceImpl.editeGoods((goods.GoodsRequest) request,
              (io.grpc.stub.StreamObserver<goods.ListOfGoods>) responseObserver);
          break;
        case METHODID_ORDER_GOODS:
          serviceImpl.orderGoods((goods.OrderRequest) request,
              (io.grpc.stub.StreamObserver<goods.OrderResponse>) responseObserver);
          break;
        default:
